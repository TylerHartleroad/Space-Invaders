/****************************************************************************
** Meta object code from reading C++ file 'fleet.h'
**
...
#include "../../space-invaders/fleet.h"
...
#error "The header file 'fleet.h' doesn't include <QObject>."
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSFleetENDCLASS_t qt_meta_stringdata_CLASSFleetENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(6, 14),  // "AlienDestroyed"
        QT_MOC_LITERAL(21, 0),  // ""
        QT_MOC_LITERAL(22, 14)   // "FleetDestroyed"
    },
    "Fleet",
    "AlienDestroyed",
    "",
...
Q_CONSTINIT const QMetaObject Fleet::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSFleetENDCLASS_t,
        ...
        // method 'AlienDestroyed'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'FleetDestroyed'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void Fleet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->AlienDestroyed(); break;
        case 1: _t->FleetDestroyed(); break;
        default: ;
        }
        ...
        {
            using _t = void (Fleet::*)();
            if (_t _q_method = &Fleet::AlienDestroyed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Fleet::*)();
            if (_t _q_method = &Fleet::FleetDestroyed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Fleet::AlienDestroyed()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Fleet::FleetDestroyed()
{
