...
Q_CONSTINIT static const qt_meta_stringdata_CLASSGameENDCLASS_t qt_meta_stringdata_CLASSGameENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(5, 15),  // "PlayerDestroyed"
        QT_MOC_LITERAL(21, 0)   // ""
    },
    "Game",
    "PlayerDestroyed",
...
void Game::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->PlayerDestroyed(); break;
        default: ;
        }
        ...
        {
            using _t = void (Game::*)();
            if (_t _q_method = &Game::PlayerDestroyed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
