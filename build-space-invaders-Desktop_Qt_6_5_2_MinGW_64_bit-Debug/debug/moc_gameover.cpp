...
#include "../../space-invaders/gameover.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSGameOverENDCLASS_t qt_meta_stringdata_CLASSGameOverENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(9, 14),  // "RestartRequest"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 11)   // "QuitRequest"
    },
    "GameOver",
    "RestartRequest",
    "",
...
void GameOver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->RestartRequest(); break;
        case 1: _t->QuitRequest(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &GameOver::RestartRequest; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (GameOver::*)();
            if (_t _q_method = &GameOver::QuitRequest; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void GameOver::RestartRequest()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void GameOver::QuitRequest()
{
