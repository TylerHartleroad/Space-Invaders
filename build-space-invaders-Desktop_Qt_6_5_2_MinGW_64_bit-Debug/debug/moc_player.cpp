...
#include "../../space-invaders/player.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSPlayerENDCLASS_t qt_meta_stringdata_CLASSPlayerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 12),  // "LivesUpdated"
        QT_MOC_LITERAL(20, 0),  // ""
        QT_MOC_LITERAL(21, 5),  // "lives"
        QT_MOC_LITERAL(27, 9),  // "PlayerHit"
        QT_MOC_LITERAL(37, 15),  // "PlayerDestroyed"
        QT_MOC_LITERAL(53, 8),  // "MoveLeft"
        QT_MOC_LITERAL(62, 9),  // "MoveRight"
        QT_MOC_LITERAL(72, 5)   // "Shoot"
    },
    "Player",
    "LivesUpdated",
    "",
...
void Player::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->LivesUpdated((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->PlayerHit(); break;
        case 2: _t->PlayerDestroyed(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Player::LivesUpdated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &Player::PlayerHit; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Player::*)();
            if (_t _q_method = &Player::PlayerDestroyed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Player::LivesUpdated(int _t1)
{
